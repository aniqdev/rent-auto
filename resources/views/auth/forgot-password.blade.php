...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="passwordBody" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-minimize-hoverable page-loading">
					...
					<div class="container row">
						<div class="col-lg-6 d-flex align-items-center">
							<div class="login-form login-signin">
                                {!! Form::open(['route' => 'password.email', 'class' => 'form w-xxl-550px bg-white rounded-lg p-20']) !!}
									<div class="pb-13 pt-lg-0 pt-5">
										<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Obnovit heslo</h3>
									</div>
									...
									<div class="pb-lg-0 pb-5">
                                        {!! Form::button('Resetovat heslo', ['type' => 'submit', 'class' => 'btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3']) !!}
									</div>
                                {!! Form::close() !!}
							</div>
						</div>
