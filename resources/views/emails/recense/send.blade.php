											...
											<div style="color:#6a6a6a;font-family:Raleway, Trebuchet MS, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:0px;padding-bottom:45px;padding-left:0px;">
												<div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #6a6a6a; font-family: Raleway, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 17px;">
                                                    ...
                                                    <p style="padding-bottom: 10px;margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>věříme, že jste si užili dovolenou v našem obytném voze. Chtěli bychom Vás poprosit o pár sekund Vašeho času k napsání krátkého hodnocení této zkušenosti.</strong></span>
                                                    <p style="padding-bottom: 10px;margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>Vaše recenze je pro nás velmi důležitá. Dozvíme se z ní, co děláme správně a co je třeba zlepšit, abychom splnili Vaše očekávání.</strong></span>
                                                    </p>
                                                    <p style="margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>Těšíme se na Vaši příští rezervaci!</strong></span>
                                                    </p>
                                                    </strong></span></p>
												</div>
											</div>
												...
												<div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #6a6a6a; font-family: Raleway, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 17px;">
													<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                        ...
                                                        text-align: center;">
                                                            ...
                                                            <strong ><a style="color: #ffffff; text-decoration: none;" href="{{ route('reviews.show', $reservation->id) }}?sign={{$sign}}">Napsat Recenzi</a></strong>
