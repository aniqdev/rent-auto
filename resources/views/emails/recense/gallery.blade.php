...
<head>
	...
	<title>TopObytneVozy.cz - Jaký byl váš zážitek v obytném voze?</title>
</head>
									...
									<div class="col_cont" style="width:100% !important;">
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											...
											<div style="color:#6a6a6a;font-family:Raleway, Trebuchet MS, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:0px;padding-bottom:45px;padding-left:0px;">
												<div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #6a6a6a; font-family: Raleway, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 17px;">
													<p style="padding-bottom: 10px;margin: 0; font-size: 20px; line-height: 1.2; word-break: break-word; text-align: start; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;">
                                                            <strong>Krásný den kravanisto,</strong>
                                                        </span>
                                                    </p>
                                                    <p style="padding-bottom: 10px;margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>věříme, že je na Vaší dovolené v obytném voze vše v pořádku a užíváte si jí na maximum. V případě, že budete pořizovat fotografie, budeme moc rádi když nám nějakou zašlete.</strong></span>
                                                    <p style="padding-bottom: 10px;margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>Fotky použijeme na našich sociálních sítích nebo webových stránkách, a tak inspirujeme další cestovatele, kteří nad pronájmem obytného vozu přemýšlejí.</strong></span>
                                                    </p>
                                                    <p style="margin: 0; font-size: 15px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 18px; margin-top: 0; margin-bottom: 0;">
                                                        <span style="font-size: 15px;"><strong>Přejeme hezký zbytek dovolené!</strong></span>
                                                    </p>
                                                    </strong></span></p>
												</div>
											</div>
						...
						<div class="block-grid " style="min-width: 320px; max-width: 640px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: transparent;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
								<div class="col num12" style="min-width: 320px; max-width: 640px; display: table-cell; vertical-align: top; width: 640px;">
									<div class="col_cont" style="width:100% !important;">
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											<div style="color:#6a6a6a;font-family:Raleway, Trebuchet MS, Helvetica, sans-serif;line-height:1.2;padding-right:0px;padding-left:0px;">
												<div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #6a6a6a; font-family: Raleway, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 17px;">
													<p style="margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
                                                        ...
                                                        width: auto;
                                                        text-align: center;">
                                                            {{-- <strong><a href="{{ url('/recenze/{{ $reservation->id }}') }}">Click me!</a></strong> --}}
                                                            <strong ><a style="color: #ffffff; text-decoration: none;" href="{{ route('client-gallery.show', $reservation->id) }}?sign={{$sign}}">Poslat Foto</a></strong>
                                                            {{-- ('mail::button', ['url' => route('send-mail-link')]) --}}
                                                        </span>
                                                    </p>
												</div>
											</div>
