...
<head>
	...
	<title>Topobytnevozy.cz - Nezaplacená celková částka rezervace</title>
</head>
										...
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
											...
											<div style="color:#6a6a6a;font-family:Raleway, Trebuchet MS, Helvetica, sans-serif;line-height:1.2;padding-top:10px;padding-right:0px;padding-bottom:45px;padding-left:0px;">
												<div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; color: #6a6a6a; font-family: Raleway, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 17px;">
                                                    ...
                                                    <p>
                                                        informujeme Vás ohledně Vaší rezervace obytného vozu, u které evidujeme nezaplacenou celkovou částku za pronájem.
                                                    </p>

                                                    <p>
                                                        Věříme, že došlo pouze k nedorozumění, a tak prosíme o zaplacení celkové částky v co nejbližší době. Pokud jste již doplacení pronájmu uskutečnili, berte tento email za bezpředmětný.
                                                    </p>
                                                    <p>
                                                        V případě platby 30 000,- Kč za vratnou kauci použijte stejné platební údaje, jen do zprávy pro příjemce napište ,,vratná kauce Jméno a Příjmení,,.
                                                    </p>
                                                    <p>
                                                        Platbu vratné kauce můžete provést také v hotovosti při převzetí obytného vozu.
                                                    </p>
                                                    </strong></span></p>
												</div>
											</div>
