<div class="dropdown mr-1">
    ...
    <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
        <form>
            <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{ asset('images/bg-3.jpg') }})">
                <h4 class="d-flex flex-center rounded-top">
                    <span class="text-white">Centrum zpráv</span>
                    <span class="btn btn-success btn-sm font-weight-bold ml-2">{{ $notifications->count() }}</span>
                </h4>
                <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8 font-size-lg" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#topbar_notifications">Objednávky</a>
                    </li>
                    {{--  <li class="nav-item">
            ...
            <div class="tab-content">
                <div class="tab-pane p-8 active" id="topbar_notifications" role="tabpanel">
                        ...
                        @foreach($notifications as $notification)
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="{{ route('admin.rezervace.show', $notification->id) }}" class="text-dark text-hover-primary mb-1 font-size-lg">Nová objednávka</a>
                                    <span class="text-muted">Nová objednávka č. {{ $notification->id }}</span>
                                </div>
                            </div>
                        @endforeach
                        {{--  <div class="d-flex align-items-center mb-6">
