                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit pojem {{ $dictionary->name }}
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($dictionary, ['route' => ['admin.slovnik.update', $dictionary->id], 'method' => 'PUT', 'files' => true]) !!}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="symbol symbol-100 d-block">
                                            <img src="{{ asset('storage/' . $dictionary->thumbnail) }}" alt="Obrázek pojmu">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        {!! Form::text('seo_title', null, ['class' => 'form-control', 'placeholder' => 'Náprava']) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        {!! Form::label('published_at', 'Publikováno') !!}
                                        <span class="switch">
                                            <label>
                                                {!! Form::checkbox('published_at', true) !!}
                                                <span></span>
                                            </label>
                                        </span>
