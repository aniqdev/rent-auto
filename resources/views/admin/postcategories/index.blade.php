            ...
            <div class="d-flex align-items-center flex-wrap">
                @can('Vytvořit příspěvek')
                    <div data-toggle="tooltip" title="" data-placement="top" data-original-title="Nová kategorie">
                        <a href="{{ route('aktuality-kategorie.create') }}" class="btn btn-fixed-height btn-primary font-weight-bolder font-size-sm px-5 my-1">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle" nowrap>
                                                    @can('Upravit příspěvek')
                                                        @if(!$category->trashed())
                                                            <a href="{{ route('aktuality-kategorie.edit', $category->id) }}" class="btn btn-sm btn-clean btn-icon mr-2" title="Upravit">
                                                                <span class="svg-icon svg-icon-md">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    ...
                                                    @can('Smazat příspěvek')
                                                        @if($category->trashed())
                                                            <a href="{{ route('aktuality-kategorie.restore', $category) }}" class="btn btn-sm btn-clean btn-icon" title="Obnovit">
                                                                <span class="svg-icon svg-icon-md">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        @else
                                                            {!! Form::open(['method' => 'delete', 'route' => ['aktuality-kategorie.destroy', $category], 'style'=>'display: inline']) !!}
