        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Správa kategorií aktualit</h5>
                </div>
            </div>
                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit kategorií {{ $category->name }}
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($category, ['route' => ['aktuality-kategorie.update', $category->id], 'method' => 'PUT']) !!}
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        {!! Form::label('name', 'Název') !!}
                                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Novinky']) !!}
                                        <span class="form-text text-muted">Prosím zadejte název kategorie.</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="tinyeditor form-control" id="description">
                                            {!! $category->description !!}
                                        </div>
                                        <span class="form-text text-muted">Prosím zadejte popis kategorie.</span>
                                    </div>
                                </div>
                                <div class="separator separator-dashed my-10"></div>
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        {!! Form::text('seo_title', null, ['class' => 'form-control', 'placeholder' => 'Novinky']) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        {!! Form::text('seo_description', null, ['class' => 'form-control', 'placeholder' => 'Novinky ze světa karavanů ...']) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        {!! Form::text('seo_keywords', null, ['class' => 'form-control', 'placeholder' => 'novinky, články, karavany']) !!}
