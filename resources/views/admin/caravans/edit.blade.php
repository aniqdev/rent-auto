                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit karavan <strong>{{ $caravan->name }}</strong>
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($caravan, ['route' => ['admin.karavany.update', $caravan->id], 'method' => 'PUT', 'files' => true]) !!}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="custom-file">
                                            {!! Form::file('thumbnail[]', ['class' => 'custom-file-input dropzone']) !!}
                                        ...
                                        @if(!empty($caravan->thumbnail))
                                            <div class="symbol symbol-120 mr-3">
                                                <img src="{{ asset('storage/' . $caravan->thumbnail) }}" alt="">
                                            </div>
                                        @endif
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        @if(!empty($caravan->photos))
                                            <photo-manager :data="{{ $caravan->photos }}" :model="{{ $caravan->id }}"></photo-manager>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    @foreach($tabs as $tab)
                                        <div class="col-lg-6 mb-10">
                                            ...
                                            <div class="tinyeditor form-control" id="{{ 'tab[' . $tab->id . ']' }}" placeholder="">
                                                {!! $caravan->getTabById($tab->id)->pivot->text ?? '' !!}
                                            </div>
                                            ...
                                            <div class="col-md-3 mb-8">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][1]', $caravan->getSeasonById($season->id)->pivot->day_1 ?? null, ['class' => 'form-control', 'placeholder' => 'Pondělí']) !!}
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][2]', $caravan->getSeasonById($season->id)->pivot->day_2 ?? null, ['class' => 'form-control', 'placeholder' => 'Úterý']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][3]', $caravan->getSeasonById($season->id)->pivot->day_3 ?? null, ['class' => 'form-control', 'placeholder' => 'Středa']) !!}
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][4]', $caravan->getSeasonById($season->id)->pivot->day_4 ?? null, ['class' => 'form-control', 'placeholder' => 'Čtvrtek']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][5]', $caravan->getSeasonById($season->id)->pivot->day_5 ?? null, ['class' => 'form-control', 'placeholder' => 'Pátek']) !!}
                                                    </div>
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][6]', $caravan->getSeasonById($season->id)->pivot->day_6 ?? null, ['class' => 'form-control', 'placeholder' => 'Sobota']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-6 col-md-12">
                                                        {!! Form::text('day[' . $season->id . '][7]', $caravan->getSeasonById($season->id)->pivot->day_7 ?? null, ['class' => 'form-control', 'placeholder' => 'Neděle']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
