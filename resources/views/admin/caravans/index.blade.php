...
@section('content')
    <div class="subheader py-6 py-lg-8 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                @can('Vytvořit vozidlo')
                    <div data-toggle="tooltip" title="" data-placement="top" data-original-title="Nový karavan">
                        <a href="{{ route('admin.karavany.create') }}" class="btn btn-fixed-height btn-primary font-weight-bolder font-size-sm px-5 my-1 mr-3">
                        ...
                        </span>Přidat nový karavan</a>
                    </div>
                @endcan

                @can('Vytvořit vozidlo')
                    <div data-toggle="tooltip" title="" data-placement="top" data-original-title="Zkopírovat karavan">
                        <a href="{{ route('admin.karavany.copy') }}" class="btn btn-fixed-height btn-bg-white btn-text-dark-50 btn-hover-text-primary btn-icon-primary font-weight-bolder font-size-sm px-5 my-1">
                        <span class="svg-icon svg-icon-md">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <caravans-index :data="{{ $caravans }}"></caravans-index>
        </div>
    </div>
@endsection
