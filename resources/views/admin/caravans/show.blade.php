        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Karavan <span class="text-primary font-weight-bold">{{ $caravan->name }}</span></h5>
                </div>
            </div>
                            ...
                            <div class="d-flex">
                                <div class="flex-shrink-0 mr-7">
                                    <div class="symbol symbol-50 symbol-lg-120 symbol-circle">
                                        <img src="{{ asset('storage/' . $caravan->thumbnail) }}">
                                    </div>
                                </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                    ...
                                    <div class="d-flex flex-column text-dark-75">
                                        ...
                                        <span class="font-weight-bolder font-size-h5">{{ $caravan->sort }}</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                    <span class="mr-4">
                                    ...
                                    <div class="d-flex flex-column text-dark-75">
                                        <span class="font-weight-bolder font-size-sm">Kategorie</span>
                                        <span class="font-weight-bolder font-size-h5">{{ $caravan->caravan_category->name }}</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                    <span class="mr-4">
                                    ...
                                    <div class="d-flex flex-column text-dark-75">
                                        ...
                                        <span class="font-weight-bolder font-size-h5">
                                            {{ $caravan->earnings }}<span class="text-dark-50 font-weight-bold">Kč</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                    ...
                                    <div class="d-flex flex-column text-dark-75">
                                        ...
                                        <span class="font-weight-bolder font-size-h5">
                                            {{ $caravan->reservations->count() }}<span class="text-dark-50 font-weight-bold">x</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Výdělky dle rezervací</span>
                                    <span class="d-block text-muted mt-2 font-size-sm">Počet rezervací: {{ $caravan->reservations->count() }}</span>
                                </h3>
                            </div>
                        ...
                        <div class="card-body" style="position: relative;">
                            <caravan-earnings :caravan="{{ $caravan->id }}"></caravan-earnings>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header h-auto border-0">
                            <div class="card-title py-5">
                                <h3 class="card-label">
                                    <span class="d-block text-dark font-weight-bolder">Rezervace</span>
                                    <span class="d-block text-muted mt-2 font-size-sm">Seznam rezervací</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card-body">
                            @foreach($caravan->reservations as $reservation)
                                <div class="d-flex align-items-center mb-4">
                                    <div class="d-flex flex-column flex-grow-1">
                                        <a href="{{ route('admin.rezervace.show', $reservation->id) }}" class="text-dark-75 text-hover-primary mb-1 font-weight-bolder font-size-lg">Rezervace č. {{ $reservation->id }}</a>
                                        <span class="text-muted font-weight-bold">{{ $reservation->start_date->format('d.m.Y') }} - {{ $reservation->end_date->format('d.m.Y') }}</span>
                                    </div>
                                    <div class="d-flex flex-column flex-grow-1">
                                        <span class="text-dark-75">{{ $reservation->customer_name }}</span>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <span class="text-dark-75 font-size-lg font-weight-bolder text-right">{{ number_format($reservation->total_price, 0, ',', ' ') }} Kč</span>
                                    </div>
                                </div>
                            @endforeach
                        </div>
