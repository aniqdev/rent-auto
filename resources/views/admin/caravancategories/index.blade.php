...
@section('content')
            ...
            <div class="d-flex align-items-center flex-wrap">
                @can('Vytvořit kategorií vozidel')
                    <div data-toggle="tooltip" title="" data-placement="top" data-original-title="Nová kategorie">
                        <a href="{{ route('admin.karavany-kategorie.create') }}" class="btn btn-fixed-height btn-primary font-weight-bolder font-size-sm px-5 my-1">
                        ...
                        </span>Přidat kategorií karavanů</a>
                    </div>
                @endcan
            </div>
        </div>
    ...
    <div class="d-flex flex-column-fluid">
        <div class="container">
            <categories-index :data="{{ $categories }}"></categories-index>
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0 mr-7">
                                <div class="symbol symbol-50 symbol-lg-120 symbol-circle">
                                    <img alt="Obrázek kategorie" src="{{ asset('storage/images/' . $category->thumbnail) }}">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                    ...
                                    <div class="my-lg-0 my-1">
                                        @can('Upravit kategorií vozidel')
                                            <a href="{{ route('karavany-kategorie.edit', $category->id) }}" class="btn btn-sm btn-light-primary font-weight-bolder mr-2">Upravit</a>
                                        @endcan
                                        @can('Smazat kategorií vozidel')
                                            {!! Form::open(['method' => 'delete', 'route' => ['karavany-kategorie.destroy', $category->id], 'style'=>'display: inline']) !!}
                                                <button type="submit" class="btn btn-sm btn-danger font-weight-bolder" title="Smazat" onclick="return confirm('Vážně si přejete odstranit tuto kategori?')">Smazat</button>
                                            {!! Form::close() !!}
                                        @endcan
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                ...
                                <div class="d-flex flex-column text-dark-75">
                                    ...
                                    <span class="font-weight-bolder font-size-h5">4</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                <span class="mr-4">
                                ...
                                <div class="d-flex flex-column text-dark-75">
                                    ...
                                    <span class="font-weight-bolder font-size-h5">
                                        <span class="text-dark-50 font-weight-bold">Kč</span>480,500
                                    </span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                ...
                                <div class="d-flex flex-column text-dark-75">
                                    ...
                                    <span class="font-weight-bolder font-size-h5">
                                        45<span class="text-dark-50 font-weight-bold">x</span>
                                    </span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                                ...
                                <div class="d-flex flex-column flex-lg-fill">
                                    <span class="text-dark-75 font-weight-bolder font-size-sm">Pozice</span>
