                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit kategorií <strong>{{ $category->name }}</strong>
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($category, ['route' => ['admin.karavany-vlasnosti.update', $category->id], 'method' => 'PUT']) !!}
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        {!! Form::label('name', 'Jméno kategorie') !!}
                                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Technické údaje']) !!}
                                        <span class="form-text text-muted">Prosím zadejte název kategorie atributů.</span>
                                    </div>
                                </div>
                            </div>
