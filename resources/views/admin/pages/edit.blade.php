                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit stránku <strong>{{ $page->name }}</strong>
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($page, ['route' => ['admin.stranky.update', $page->id], 'method' => 'PUT', 'files' => true]) !!}
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-2">
                                        @if($page->thumbnail)
                                            <div class="symbol symbol-100 d-block">
                                                <img src="{{ asset('storage/' . $page->thumbnail) }}" alt="Obrázek stránky">
                                            </div>
                                        @endif
                                    </div>
                                </div>
