    ...
    <div class="subheader py-6 py-lg-8 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap">
                @can('Vytvořit kupón')
                    <div data-toggle="tooltip" title="" data-placement="top" data-original-title="Nové pravidlo">
                        <a href="{{ route('admin.slevy.create') }}" class="btn btn-fixed-height btn-primary font-weight-bolder font-size-sm px-5 my-1">
