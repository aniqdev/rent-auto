...
<body>
    <header style="width: 100%; height: 10%; padding: 0 54px;">
        ...
        <div style="text-align: right; padding-top: 24px; white-space: nowrap;">
            ZBYTEK FAKTURA {{ $reservation->created_at->format('Y') }}-{{ $reservation->id }}
        </div>
    </header>
    ...
    <main>
        <div class="row">
            <div class="col-2">
                ...
                <div style="font-size: 30px; font-weight: bold;">{{ number_format($price - ($price * 0.30), 2, ',', ' ') }} Kč</div>
            </div>
            <div class="col-2">
                <div class="d-block">
                    <table>
    ...
    <main>
        <div class="row">
            ...
            <div class="col-3" style="text-align: center;">
                <img src="http://api.paylibo.com/paylibo/generator/czech/image?accountNumber=410517002&bankCode=5500&amount={{ $price - ($price * 0.30) }}&currency=CZK&vs={{ $reservation->id }}&message=Pronajem&branding=false" alt="QR kód" width="66%">
            </div>
