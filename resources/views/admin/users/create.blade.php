            ...
            <div class="row mb-8">    
                <div class="col-lg-12">
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        ...
                        {!! Form::open(['route' => 'uzivatele.store'], ) !!}
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        {!! Form::label('zip', 'PSČ') !!}
                                        {!! Form::text('zip', null, ['class' => 'form-control', 'placeholder' => '14000']) !!}
                                    ...
                                    <div class="col-lg-11">
                                        <div class="radio-inline">
                                            @foreach($roles as $role)
                                                <label class="radio radio-solid" data-toggle="tooltip" data-placement="top" data-html="true" title="@foreach($role->users as $user) {{ $user->name }}<br> @endforeach">
