                    ...
                    <div class="card card-custom" data-card="true" id="kt_card_1">
                        <div class="card-header">
                            <div class="card-title">
                                <h3 class="card-label">
                                    Upravit slevový kupón <strong>{{ $coupon->name }}</strong>
                                </h3>
                            </div>						
                        </div>

                        {!! Form::model($coupon, ['route' => ['kupony.update', $coupon->id], 'method' => 'PUT']) !!}
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        {!! Form::select('type', ['value' => 'Částka', 'percent' => 'Percentuální hodnota'], null, ['class' => 'form-control', 'disabled']) !!}
                                        <span class="form-text text-muted">Prosím vyberte druh slevy.</span>
                                    </div>
                                    <div class="col-lg-4">
                                        {!! Form::label('discount', 'Sleva') !!}
                                        {!! Form::number('discount', null, ['class' => 'form-control', 'step' => '.10', 'placeholder' => '50', 'disabled']) !!}
