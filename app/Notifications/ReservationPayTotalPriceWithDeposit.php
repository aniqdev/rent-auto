...
class ReservationPayTotalPriceWithDeposit extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->markdown('mail.reservation.paytotalpricewithdeposit', [
                'bankwire_name' => 'TopCars RENT s.r.o.',
                'bankwire_number' => '410517002/5500',
                'bankwire_bank' => 'Raiffeisen Bank',
                'bankwire_price' => number_format($this->reservation->total_price, 0, '.', ' '),
