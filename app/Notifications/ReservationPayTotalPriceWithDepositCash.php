...
class ReservationPayTotalPriceWithDepositCash extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->markdown('mail.reservation.paytotalpricewithdepositcash', [
                'cash_price' => number_format($this->reservation->total_price, 0, '.', ' '),
